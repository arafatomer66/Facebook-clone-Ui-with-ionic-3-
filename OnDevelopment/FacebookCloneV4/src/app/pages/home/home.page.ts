...
import { NavController, ActionSheetController, IonicPage, ModalController, 
  PopoverController, IonInfiniteScroll, IonContent, Events, Platform, App } from '@ionic/angular';
...
export class HomePage implements OnInit {
  ...
  constructor(
		...
		private timelineProvider: TimelineService,
  ...
  addView(postId) {
	...
	//infinite scroll
	doInfinite(infiniteScroll: IonInfiniteScroll) {
